      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 py-2">
            ...
            {/* 4. Bandeira (Opcional com Ícones Visuais) */}
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="card-institution"
                placeholder="Ex: Nu Pagamentos S.A., Banco Inter S.A."
            ...
            {/* 9 & 10. Dias de Fechamento e Vencimento */}
            ...
            {/* 11. Foto do Cartão (Upload de Imagem Opcional) */}
            <div className="space-y-2 pt-1 border-t border-slate-100">
              <Label htmlFor="card-photo" className="flex items-center gap-1.5">
                <ImageIcon className="h-4 w-4 text-primary" /> Foto / Imagem do Cartão (Opcional)
              </Label>

              {/* Preview de imagem */}
              {(form.imagePreviewUrl || form.existingImageUrl) && (
                <div className="relative rounded-lg overflow-hidden border border-slate-200 bg-slate-100 h-28 flex items-center justify-center group">
                  <img
            ...
            <div className="space-y-1.5 pt-1 border-t border-slate-100">
              <Label>Cor de Fundo do Cartão</Label>
